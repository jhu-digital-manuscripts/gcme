...
const debug = (0, debug_1.default)('ember-auto-import:splitter');
class Splitter {
    constructor(options) {
    ...
    importsChanged() {
        ...
        if (!this.lastImports || !(0, util_1.shallowEqual)(this.lastImports, imports)) {
    ...
    computeTargets(analyzers) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let imports = (0, lodash_1.flatten)([...analyzers.keys()].map((analyzer) => analyzer.imports));
    ...
    versionOfPackage(packageRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let pkg = require((0, path_1.join)(packageRoot, 'package.json'));
    ...
    assertSafeVersion(alreadyResolved, nextImport, nextTarget) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(0, semver_1.satisfies)(haveVersion, requestedRange, { includePrerelease: true })) {
    ...
    computeDeps(analyzers) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let target of targets.targets.values()) {
                let [dynamicUses, staticUses] = (0, lodash_1.partition)(target.importedBy, (imp) => imp.isDynamic);
    ...
    sortBundle(bundle) {
        bundle.staticImports.sort((a, b) => a.requestedSpecifier.localeCompare(b.requestedSpecifier));
        bundle.dynamicImports.sort((a, b) => a.requestedSpecifier.localeCompare(b.requestedSpecifier));
