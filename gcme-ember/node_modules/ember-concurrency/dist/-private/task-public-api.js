...
function task() {
  ...
  assert(`Using task(...) in any form other than \`task(async () => {})\` is no longer supported since ember-concurrency v5. Please use the modern syntax instead (and consider using one of ember-concurrency's codemods).`, false);
}
