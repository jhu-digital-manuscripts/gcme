...
import { isEventedObject, EmberYieldable, getValueFromStringPath } from './utils.js';
...
class WaitForPropertyYieldable extends EmberYieldable {
  constructor(object, key, predicateCallback = Boolean) {
    ...
    this.object = object;
    this.key = key;
    deprecate('waitForProperty is deprecated due to its use of observers. Consider using a polling approach instead.', false, {
