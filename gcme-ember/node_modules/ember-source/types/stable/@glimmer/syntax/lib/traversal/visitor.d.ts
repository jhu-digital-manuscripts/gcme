declare module '@glimmer/syntax/lib/traversal/visitor' {
    import type * as ASTv1 from "@glimmer/syntax/lib/v1/api";
    import type { VisitorKey } from "@glimmer/syntax/lib/v1/visitor-keys";
    import type WalkerPath from "@glimmer/syntax/lib/traversal/path";
