declare module '@glimmer/syntax/lib/v1/handlebars-ast' {
    /**
    ...
    export type UpstreamNode<T extends UpstreamNodeType = UpstreamNodeType> = UpstreamNodeMap[T]["input"];
    ...
    export type Statement = MustacheStatement | BlockStatement | DecoratorBlock | PartialStatement | PartialBlockStatement | ContentStatement | CommentStatement;
