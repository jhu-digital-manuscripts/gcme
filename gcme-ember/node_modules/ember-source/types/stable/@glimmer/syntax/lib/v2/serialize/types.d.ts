declare module '@glimmer/syntax/lib/v2/serialize/types' {
    import type { PresentArray } from "@glimmer/interfaces";
    import type { SerializedSourceSlice } from "@glimmer/syntax/lib/source/slice";
    ...
    export type SerializedVariableReference = SerializedThisReference | SerializedArgReference | SerializedLocalVarReference | SerializedFreeVarReference;
    ...
    export type SerializedExpressionNode = SerializedLiteralExpression | SerializedPathExpression | SerializedCallExpression | SerializedDeprecatedCallExpression | SerializedInterpolateExpression;
    ...
    export type SerializedContentNode = SerializedAppendContent | SerializedHtmlComment | SerializedHtmlText | SerializedGlimmerComment | SerializedInvokeBlock | SerializedInvokeComponent | SerializedSimpleElement;
}