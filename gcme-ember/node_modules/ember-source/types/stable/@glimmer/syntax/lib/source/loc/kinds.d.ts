declare module '@glimmer/syntax/lib/source/loc/kinds' {
    ...
    export const HBS_POSITION_KIND: HbsPositionKind;
    /**
    ...
    export const INTERNAL_SYNTHETIC_KIND: InternalSyntheticKind;
    /**
    ...
    export const NON_EXISTENT_KIND: NonExistentKind;
    /**
    ...
    export const BROKEN_KIND: BrokenKind;
