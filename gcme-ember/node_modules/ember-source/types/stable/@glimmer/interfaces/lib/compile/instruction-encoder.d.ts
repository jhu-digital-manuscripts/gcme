declare module '@glimmer/interfaces/lib/compile/instruction-encoder' {
    import type { CompilerBuffer } from "@glimmer/interfaces/lib/template.js";
    import type { VmMachineOp, VmOp } from "@glimmer/interfaces/lib/vm-opcodes.js";
    import type { Operand } from "@glimmer/interfaces/lib/compile/operands.js";
