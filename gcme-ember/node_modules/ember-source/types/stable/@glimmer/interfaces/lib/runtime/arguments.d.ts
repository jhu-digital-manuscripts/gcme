declare module '@glimmer/interfaces/lib/runtime/arguments' {
    import type { Nullable } from "@glimmer/interfaces/lib/core.js";
    import type { Reference } from "@glimmer/interfaces/lib/references.js";
    import type { ScopeBlock } from "@glimmer/interfaces/lib/runtime/scope.js";

    const CAPTURED_ARGS: unique symbol;
