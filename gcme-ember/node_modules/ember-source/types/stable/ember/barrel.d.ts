declare module 'ember/barrel' {
    ...
    */
    ...
    import EmberArray, { NativeArray as EmberNativeArray, isArray as emberIsArray, makeArray as emberMakeArray } from "@ember/array";
    import EmberMutableArray from "@ember/array/mutable";
    import EmberArrayProxy from "@ember/array/proxy";
    import EmberApplication, { onLoad as applicationOnLoad, runLoadHooks as applicationRunLoadHooks } from "@ember/application";
    ...
    namespace Ember {
        ...
        const meta: {
            ...
            _counters?: import("@ember/-internals/meta").MetaCounters;
        };
        ...
        const ComponentLookup: typeof views.ComponentLookup;
        ...
        const A: <T>(arr?: globalThis.Array<T>) => EmberNativeArray<T>;
        ...
        const assert: typeof EmberDebug.assert;
        const warn: typeof EmberDebug.warn;
        ...
        */
        ...
        let Test: (NonNullable<typeof EmberTestingImpl>["Test"] & {
