declare module '@ember/array' {
    ...
    interface EmberArray<T> extends Enumerable {
        ...
        */
        ...
        /**
          ...
          @public
        */
        find<S extends T, Target = void>(predicate: (this: void, value: T, index: number, obj: T[]) => value is S, thisArg?: Target): S | undefined;
        find<Target = void>(callback: (this: Target, item: T, index: number, arr: this) => unknown, target?: Target): T | undefined;
        /**
        ...
        */
        ...
        /**
          ...
          @public
        */
        invoke<M extends MethodNamesOf<T>>(methodName: M, ...args: MethodParams<T, M>): NativeArray<MethodReturns<T, M>>;
        /**
    ...
    */
     ...
     */
    type IGNORED_MUTABLE_ARRAY_METHODS = "length" | "slice" | "indexOf" | "lastIndexOf" | "forEach" | "map" | "filter" | "find" | "every" | "reduce" | "includes";
    /**
     ...
     */
    type RETURN_SELF_ARRAY_METHODS = "[]" | "clear" | "insertAt" | "removeAt" | "pushObjects" | "unshiftObjects" | "reverseObjects" | "setObjects" | "removeObject" | "removeObjects" | "addObject" | "addObjects" | "setEach";
    interface MutableArrayWithoutNative<T> extends Omit<MutableArray<T>, IGNORED_MUTABLE_ARRAY_METHODS | RETURN_SELF_ARRAY_METHODS> {
        /**
         * Remove all elements from the array. This is useful if you
         * want to reuse an existing array without having to recreate it.
         */
