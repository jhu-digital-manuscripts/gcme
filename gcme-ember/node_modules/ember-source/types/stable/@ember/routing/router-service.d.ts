declare module '@ember/routing/router-service' {
    ...
    const RouterService_base: Readonly<typeof Service> & (new (owner?: import("@ember/owner").default) => Service) & import("@ember/object/mixin").default;
    class RouterService extends RouterService_base {
        ...
        /**
          ...
          ```
           ...
           @public
         */
        urlFor<R extends Route>(routeName: string, ...args: ModelFor<R>[] | [...ModelFor<R>[], RouteOptions]): string;
        /**
