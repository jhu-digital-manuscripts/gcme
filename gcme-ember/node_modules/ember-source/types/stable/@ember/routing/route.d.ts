declare module '@ember/routing/route' {
    ...
    */
    ...
    const Route_base: Readonly<typeof EmberObject> & (new (owner?: Owner) => EmberObject) & import("@ember/object/mixin").default;
    class Route<Model = unknown> extends Route_base implements IRoute {
        ...
        /**
          ...
          @public
        */
        serialize(model: Model, params: string[]): {
            [key: string]: unknown;
        } | undefined;
        /**
    ...
    export function getFullQueryParams(router: EmberRouter, state: RouteTransitionState): Record<string, unknown>;
