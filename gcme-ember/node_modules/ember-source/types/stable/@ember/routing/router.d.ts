declare module '@ember/routing/router' {
    ...
    */
    ...
    const EmberRouter_base: Readonly<typeof EmberObject> & (new (owner?: Owner) => EmberObject) & import("@ember/object/mixin").default;
    /**
    ...
    */
    class EmberRouter extends EmberRouter_base implements Evented {
        ...
        */
        ...
        _doURLTransition<M extends "handleURL" | "transitionTo">(routerJsMethod: M, url: string): import("router_js").InternalTransition<Route<unknown>>;
        /**
        ...
        */
        ...
        /**
          ...
          @return {Void}
        */
        _serializeQueryParams(routeInfos: InternalRouteInfo<Route>[], queryParams: Record<string, unknown>): asserts queryParams is Record<string, string | null | undefined>;
        /**
        ...
        */
        ...
        /**
          ...
          @return {Void}
        */
        _deserializeQueryParams(routeInfos: InternalRouteInfo<Route>[], queryParams: Record<string, unknown>): void;
        /**
        ...
        */
        ...
        /**
          ...
          @return {Void}
        */
        _pruneDefaultQueryParamValues(routeInfos: InternalRouteInfo<Route>[], queryParams: Record<string, string | null | undefined>): void;
        _doTransition(_targetRouteName: string | undefined, models: ModelFor<Route>[], _queryParams: Record<string, unknown>, _fromRouterService?: boolean): Transition;
        _processActiveTransitionQueryParams(targetRouteName: string, models: ModelFor<Route>[], queryParams: Record<string, unknown>, _queryParams: {}): void;
        /**
          ...
          @return {Void}
        */
        _prepareQueryParams(targetRouteName: string, models: ModelFor<Route>[], queryParams: Record<string, unknown>, _fromRouterService?: boolean): void;
        /**
        ...
        */
        ...
        /**
          ...
          @return {Void}
        */
        _fullyScopeQueryParams(leafRouteName: string, contexts: ModelFor<Route>[], queryParams: QueryParams): void;
        /**
          ...
          @return {Void}
        */
        _hydrateUnsuppliedQueryParams(state: TransitionState<Route>, queryParams: QueryParams, _fromRouterService: boolean): void;
    ...
    let defaultActionHandlers: {
        willResolveModel<R extends Route>(this: EmberRouter, _routeInfos: InternalRouteInfo<Route>[], transition: Transition, originRoute: R): void;
        error(this: EmberRouter, routeInfos: InternalRouteInfo<Route>[], error: Error, transition: Transition): void;
        loading(this: EmberRouter, routeInfos: InternalRouteInfo<Route>[], transition: Transition): void;
    };
