declare module '@ember/-internals/glimmer/lib/component' {
    ...
    import { ActionSupport, CoreView, EventDispatcher } from "@ember/-internals/views";
    import type { Template, TemplateFactory } from "@glimmer/interfaces";
    import type { DirtyableTag } from "@glimmer/validator";
    import type { SimpleElement } from "@simple-dom/interface";
    import { DIRTY_TAG, IS_DISPATCHING_ATTRS } from "@ember/-internals/glimmer/lib/component-managers/curly";
    /**
    ...
    */
    ...
    /**
      ...
      * `drop`
      ...
      @public
    */
    interface Component<S = unknown> extends CoreView, TargetActionSupport, ActionSupport, ComponentMethods {
    }
    const Component_base: Readonly<typeof CoreView> & (new (owner?: import("@ember/owner").default) => CoreView) & import("@ember/object/mixin").default & ComponentMethods & {
        concatenatedProperties: string[];
        classNames: readonly never[];
        classNameBindings: readonly never[];
    };
    class Component<S = unknown> extends Component_base implements PropertyDidChange {
        isComponent: boolean;
        private [SIGNATURE];
        _superRerender: this["rerender"];
        ...
        */
        ...
        _transitionTo(this: Component, state: keyof typeof ViewStates): void;
        /**
         ...
         @private
         */
        nearestOfType(klass: any): View | undefined;
        /**
         ...
         @private
         */
        nearestWithProperty(property: string): View | undefined;
        /**
        ...
        /**
         Returns the current DOM element for the view.
          ...
          @public
        */
        get element(): import("@ember/-internals/utility-types").Nullable<Element>;
        /**
