declare module '@ember/-internals/metal' {
    ...
    export { default as alias, type AliasDecorator } from "@ember/-internals/metal/lib/alias";
    ...
    export { NAMESPACES, NAMESPACES_BY_ID, addNamespace, findNamespace, findNamespaces, processNamespace, processAllNamespaces, removeNamespace, isSearchDisabled as isNamespaceSearchDisabled, setSearchDisabled as setNamespaceSearchDisabled, setUnprocessedMixins, type Namespace, } from "@ember/-internals/metal/lib/namespace_search";
}