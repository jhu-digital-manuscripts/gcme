declare module '@ember/runloop' {
    ...
    export type { Timer };
    type PartialParams<P extends any[]> = P extends [infer First, ...infer Rest] ? [] | [First] | [First, ...PartialParams<Rest>] : Required<P> extends [infer First, ...infer Rest] ? [] | [First | undefined] | [First | undefined, ...PartialParams<Partial<Rest>>] : [];
    ...
    */
    ...
    export function bind<T, M extends keyof T & PropertyKey>(target: T, methodName: M, ...args: any[]): (...args: any[]) => unknown;
    /**
