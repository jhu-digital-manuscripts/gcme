declare module '@ember/application/namespace' {
    ...
    */
    import { findNamespace, processAllNamespaces, type Namespace as MetalNamespace } from "@ember/-internals/metal";
    ...
    */
    class Namespace extends EmberObject {
        static NAMESPACES: MetalNamespace[];
        static NAMESPACES_BY_ID: {
            [name: string]: MetalNamespace;
        };
