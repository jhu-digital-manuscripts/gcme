export type Falsy = {
    isTruthy: false;
} | undefined | null | false | 0 | 0n | '' | never[];
export type TruthConvert<T> = T extends {
    ...
    isTruthy: boolean;
} ? boolean : T extends undefined | null ? false : T extends boolean ? T : T extends number ? T extends 0 ? false : number extends T ? boolean : true : T extends bigint ? T extends 0n ? false : bigint extends T ? boolean : true : T extends string ? T extends '' ? false : string extends T ? boolean : true : T extends never[] ? false : T extends ArrayLike<unknown> ? boolean : T extends object ? true : boolean;
...
export default function truthConvert<T extends number>(result: T): T extends 0 ? false : true;
