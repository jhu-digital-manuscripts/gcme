...
import { isPageObject, getPageObjectDefinition, storePageObjectDefinition } from './-private/meta.js';
import { d as dsl } from './dsl-e91e58a5.js';
import { getter } from './macros/getter.js';
import { assignDescriptors } from './-private/helpers.js';
import './-private/action.js';
import './-private/better-errors.js';
import './-private/run.js';
import 'rsvp';
import './-private/chainable.js';
import './-private/finders.js';
  ...
  if (isPageObject(blueprint)) {
    ...
    Object.getOwnPropertyNames(blueprint).forEach(key => {
      ...
      if (typeof get === 'function') {
        ...
        throw new Error(`string values are not supported in page object definitions
