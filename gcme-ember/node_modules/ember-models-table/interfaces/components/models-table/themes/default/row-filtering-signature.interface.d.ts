...
export interface RowFilteringSignature {
    ...
    Blocks: {
        default: [
            {
                RowFilteringCell: WithBoundArgs<typeof RowFilteringCell, 'themeInstance' | 'data' | 'selectedItems' | 'expandedItems' | 'expandAllRows' | 'collapseAllRows' | 'toggleAllSelection' | 'changeColumnFilter'>;
                shouldAddExtraColumn: boolean;
            }
        ];
    };
}
//# sourceMappingURL=row-filtering-signature.interface.d.ts.map