...
export interface RowFilteringCellSignature {
    ...
    Blocks: {
        default: [
            WithBoundArgs<ComponentLike<any>, 'column' | 'data' | 'selectedItems' | 'expandedItems' | 'themeInstance' | 'expandAllRows' | 'collapseAllRows' | 'toggleAllSelection' | 'changeColumnFilter' | 'clearColumnFilter'> | {
...
//# sourceMappingURL=row-filtering-cell-signature.interface.d.ts.map