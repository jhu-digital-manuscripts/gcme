...
export interface DataGroupBySelectSignature {
    ...
    Blocks: {
        default: [
            {
                Select: WithBoundArgs<typeof Select, 'options' | 'value' | 'themeInstance' | 'cssPropertyName' | 'changeValue'>;
                sort: () => void;
            }
        ];
    };
}
//# sourceMappingURL=data-group-by-select-signature.interface.d.ts.map