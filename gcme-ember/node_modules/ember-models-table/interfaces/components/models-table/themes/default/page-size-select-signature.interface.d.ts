...
export interface PageSizeSelectSignature {
    ...
    Blocks: {
        default: [
            {
                Select: WithBoundArgs<typeof Select, 'id' | 'options' | 'value' | 'type' | 'themeInstance' | 'cssPropertyName' | 'changeValue'>;
            }
        ];
    };
}
//# sourceMappingURL=page-size-select-signature.interface.d.ts.map