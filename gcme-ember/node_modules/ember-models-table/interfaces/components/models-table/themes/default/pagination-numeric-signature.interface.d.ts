...
export interface PaginationNumericSignature {
    ...
    Blocks: {
        default: [
            {
                PageNumberSelect: WithBoundArgs<typeof Select, 'id' | 'options' | 'value' | 'type' | 'themeInstance' | 'changeValue'>;
                visiblePageNumbers: PaginationNumericOption[];
            }
        ];
    };
}
//# sourceMappingURL=pagination-numeric-signature.interface.d.ts.map