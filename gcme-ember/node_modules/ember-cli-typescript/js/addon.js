...
const debug = (0, debug_1.default)('ember-cli-typescript:addon');
exports.ADDON_NAME = 'ember-cli-typescript';
exports.default = (0, ember_cli_entities_1.addon)({
    ...
    _checkBabelVersion() {
        ...
        if (!babel || !semver_1.default.gte(version, '7.17.0')) {
            ...
            this.ui.writeWarnLine(`ember-cli-typescript requires ember-cli-babel ^7.17.0, but you have ${versionString}; ` +
    ...
    _checkAddonAppFiles() {
        ...
        if (isDevelopingAddon && isRootAddon && fs_extra_1.default.existsSync(appDir)) {
            let tsFilesInApp = (0, walk_sync_1.default)(appDir, { globs: ['**/*.ts'] });
    ...
    async _forkTypecheckWorker() {
        let childProcess = (0, fork_1.default)(`${__dirname}/lib/typechecking/worker/launch`);
        let worker = await (0, child_process_1.connect)(childProcess);
