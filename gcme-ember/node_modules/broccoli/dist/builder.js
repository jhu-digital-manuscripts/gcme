...
class Builder extends events_1.EventEmitter {
    ...
    async build() {
        ...
        try {
            ...
            const buildsSkipped = (0, filter_map_1.default)(this._nodeWrappers.values(), (nw) => nw.buildState.built === false).length;
    ...
    get watchedSourceNodeWrappers() {
        return (0, filter_map_1.default)(this._nodeWrappers.values(), (nw) => {
