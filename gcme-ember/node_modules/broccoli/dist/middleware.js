...
function handleRequest(outputPath, request, response, next, options) {
    ...
    try {
        ...
        filename = (0, resolve_path_1.default)(outputPath, filename.substr(1));
    }
    catch (err) {
        ...
        if (!hasIndex) {
            ...
            const context = {
                ...
                files: fs_1.default
                    ...
                    return {
                        href: child + (isDir ? '/' : ''),
                        type: isDir ? 'dir' : path_1.default.extname(child).replace('.', '').toLowerCase(),
                    };
                }),
...
module.exports = function getMiddleware(watcher, options = {}) {
    ...
    return async function broccoliMiddleware(request, response, next) {
        ...
        try {
            ...
            const err = error;
            const context = {
                stack: (0, ansi_html_1.default)(err.stack || ''),
                liveReloadPath: options.liveReloadPath,
