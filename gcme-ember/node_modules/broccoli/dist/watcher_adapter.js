...
class WatcherAdapter extends events_1.EventEmitter {
    ...
    watch() {
        const watchers = this.watchedNodes.map((node) => {
            ...
            const watcher = (0, sane_1.default)(watchedPath, this.optionsFor(watchedPath));
            this.watchers.push(watcher);
            (0, bind_file_event_1.default)(this, watcher, node, 'change');
            (0, bind_file_event_1.default)(this, watcher, node, 'add');
            (0, bind_file_event_1.default)(this, watcher, node, 'delete');
    ...
    optionsFor(watchedPath) {
        ...
        if (this.ignored) {
            ...
            const localIgnored = this.ignored
                .map((ignoredAbsPath) => {
                const ignoredRelativePath = (0, path_1.relative)(watchedPath, ignoredAbsPath);
                if (!ignoredRelativePath.startsWith('..') && !(0, path_1.isAbsolute)(ignoredRelativePath)) {
