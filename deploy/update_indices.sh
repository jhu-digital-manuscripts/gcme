...
curl -s -H "Content-Type: application/x-ndjson" -XPOST localhost:9200/line/_bulk --data-binary "@line.ndjson"

sleep 5

curl -s -H "Content-Type: application/x-ndjson" -XPOST localhost:9200/word_dict/_bulk --data-binary "@word_dict.ndjson"

sleep 5

curl -s -H "Content-Type: application/x-ndjson" -XPOST localhost:9200/lemma_dict/_bulk --data-binary "@lemma_dict.ndjson"

sleep 5

curl -s -H "Content-Type: application/x-ndjson" -XPOST localhost:9200/lemma_tag_dict/_bulk --data-binary "@lemma_tag_dict.ndjson"
