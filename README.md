...
Install Java 17 or later and Maven 3.8 or later.

Build the command line tools with
...
ndjson files for Elasticsearch. Note that the generated data is stored in the repository
and only needs to be updated if the underlying raw data or processing has changed.
